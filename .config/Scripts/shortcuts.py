...
with open("/home/mandy/.config/qutebrowser/keys.conf.base") as qb:
    qute+=qb.read()
with open("/home/mandy/.config/ranger/rc.conf.base") as rg:
    rang+=rg.read()
with open("/home/mandy/.config/Scripts/bashrc") as bsh:
    bash+=bsh.read()
#with open("/home/mandy/.config/fish/config_base.fish") as fsh:
    #fish+=fsh.read()
...
with open("/home/mandy/.config/Scripts/folders") as fold:
...
with open("/home/mandy/.config/Scripts/configs") as conf:
...
with open("/home/mandy/.config/ranger/rc.conf", "w") as outrang:
    outrang.write(rang)
with open("/home/mandy/.config/qutebrowser/keys.conf","w") as outqb:
    outqb.write(qute)
with open(".bashrc","w") as outbash:
    outbash.write(bash)
#with open("/home/mandy/.config/fish/config.fish","w") as outfish:
    #outfish.write(fish)
